...
print("           Secuencia 0         Secuencia 1         Secuencia 2")
...
B0 = B_seq[2, 2]
print(f"\nSusceptancia homopolar de la línea (B0): {B0:.6f} uS/km")
# Susceptancia directa e inversa de la linea (B1)
B1 = B_seq[1, 1]
print(f"Susceptancia directa e inversa de la línea (B1): {B1:.6f} uS/KM")
# Susceptancia homopolar de la linea total (B0)
B0_total = B_seq[2, 2] * longitud
print(f"\nSusceptancia homopolar de la línea total (B0): {B0_total:.6f} uS")
# Susceptancia directa e inversa de la linea total (B1)
B1_total = B_seq[1, 1] * longitud
print(f"Susceptancia directa e inversa de la línea total (B1): {B1_total:.6f} uS")
